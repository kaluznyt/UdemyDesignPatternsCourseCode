namespace UdemyDesignPatternsCourse.DesignPatterns.Structural.Proxy
{
    ...
    public class Property<T> : IEquatable<Property<T>>
        where T : new()
    {
        private T value;
        ...
        public bool Equals(Property<T> other)
        {
            ...
            return ReferenceEquals(this, other) || EqualityComparer<T>.Default.Equals(this.value, other.value);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals((Property<T>)obj);
        }
